 ...
 *
 * These mirror the Pydantic schemas in `docs/specs/api-v2-deltas.md §3` and
 * `stage-registry-v2.md §5.4`. They are NOT generated from the OpenAPI spec
 * because the backend v2 routes do not exist yet (that lands in Track B5).
 *
 ...
 * @see api-v2-deltas.md §3 — "Decision on ProjectStageStatus vs PageStageStatus"
 */
