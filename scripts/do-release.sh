...
echo "   Watch the release workflow: https://github.com/pdomain/pdomain-prep-for-pgdp/actions"
echo "   Release page (once workflow finishes): https://github.com/pdomain/pdomain-prep-for-pgdp/releases/tag/$VERSION"
