...
.PHONY: help setup install-hooks refresh-version install uninstall reset remove-venv lint format \
        ...
        release-patch release-minor release-major _do-release ci-slow ci-against-master docker-build docker-run \
